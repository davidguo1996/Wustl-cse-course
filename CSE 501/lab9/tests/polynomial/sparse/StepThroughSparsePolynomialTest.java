 ...
 */
public class StepThroughSparsePolynomialTest {
	@Test
	public void test() {
		...
		assertSame(SparsePolynomial.class, threeX.getClass());
		...
		assertSame(SparsePolynomial.class, eightX.getClass());
		...
		assertSame(SparsePolynomial.class, sevenXCubedPlusEightX.getClass());
		...
		assertSame(SparsePolynomial.class, twentyOneXSquaredPlusEight.getClass());
		...
		assertSame(SparsePolynomial.class, elevenX.getClass());
		...
		assertSame(SparsePolynomial.class, sevenXCubedPlusNineteenX.getClass());
